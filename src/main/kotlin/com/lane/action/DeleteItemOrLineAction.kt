            ...
            if (treeNode != null) {
                when (treeNode.userObject) {
                    is Item -> {
                        ...
                        if (userObj.lineList != null) {
                            for (it in userObj.lineList!!) {
                                MyFileEditorManagerListener.updateEyeState(myProjectService, it.fileRelativePath, editor!!)
                    ...
                    is Line -> {
                        ...
                        MyFileEditorManagerListener.updateEyeState(myProjectService, userObj.fileRelativePath, editor!!)
